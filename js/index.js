...
/////////////////////////////////
    ...
    }else if(filtinput==='music') {
   resultPara.textContent = 'playing';
    resultPara.style.background = 'yellow';
   res.innerHTML = "";
   box.classList.add('talk');
...
//////////////////////////////////////////////
	///////////Stella Fun Q&A///////////
	/////////////////////////////////////////////
   }else if(filtinput==='will i ever get married') {
   resultPara.textContent = 'Interesting question! Looking for your future wife.';
    resultPara.style.background = 'yellow';
   res.innerHTML = "Interesting question! Looking for your future wife.";
   box.classList.add('talk');
	...
	///////////Stella Events///////////
	///////////////////////////////
 } else if (filtinput.match("game", "games")) {
